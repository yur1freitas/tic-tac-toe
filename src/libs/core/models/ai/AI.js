...
export class AI {
    ...
    static _difficulty(game, mode) {
        const probability = AILevel[mode]
        const random = Math.random()

        return random > probability ? AI._bestPosition(game) : AI._randomPosition(game)
    }
     ...
     */
    static mark(game) {
        const [row, col] = game.board.isEmpty ? AI._randomPosition(game) : AI._difficulty(game, 'hard')
